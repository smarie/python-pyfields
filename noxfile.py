...
ENVS = {
    ...
    (PY35, "typeguard"): {"coverage": False, "type_checker": "typeguard", "pkg_specs": {"pip": ">19"}},
    # --- python 3.6
    (PY36, "no-typechecker"): {"coverage": False, "type_checker": None, "pkg_specs": {"pip": ">19"}},
...
def tests(session: PowerSession, coverage, type_checker, pkg_specs):
    ...
    # install optional typechecker
    if type_checker is not None:
        session.install2(type_checker)
